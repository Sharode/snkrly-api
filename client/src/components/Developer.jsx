    ...
    return (
        <div className="mx-6 bg-white text-gray-800 ">
            <section className="flex flex-col py-5 md:flex-row">
                ...
                <div className="bg-gray-700 text-gray-200 rounded-lg mt-4 min-h-6 text-sm md:w-1/2 md:h-20  md:mt-12 md:ml-2">
                    <div className="bg-gray-800 rounded-t-lg p-2 pl-4 ">
                        <h1 className=""> Base URL</h1>
                    </div>
                    <div>
                        <h1 className=" p-2 pl-4">http://snkrly.herokuapp.com/api/test/snkrs</h1>
                    </div>
                </div>
            </section>
