        ...
        <Fragment>
            ...
            <div className="px-6 bg-white text-gray-800 h-screen md:px-48" >
                ...
                <div className="flex flex-row inline justify-between md:justify-around">
                    <Link className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 ml-10 border border-gray-400 rounded shadow" to="/developer">
                        View Docs
                </Link>
                    <Link className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 mr-10 border border-gray-400 rounded shadow" to="/product">
                        View Product
                </Link>
                </div>
